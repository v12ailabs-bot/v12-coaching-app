  ...
  return (
    <div>
      ...
      <Card>
        ...
        <Fld label="How did your workouts feel?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.workout_feel||""} onChange={e=>set("workout_feel",e.target.value)} placeholder="Strong, tired, inconsistent..." style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
        <Fld label="How was your pump & muscle engagement?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.pump||""} onChange={e=>set("pump",e.target.value)} placeholder="" style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
        <Fld label="Any exercises feel especially bad or good?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.exercise_feedback||""} onChange={e=>set("exercise_feedback",e.target.value)} placeholder="" style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
        <Fld label="Did any lifts or movements improve?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.lifts_improved||""} onChange={e=>set("lifts_improved",e.target.value)} placeholder="" style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
        <Fld label="Did anything feel weaker than usual?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.felt_weaker||""} onChange={e=>set("felt_weaker",e.target.value)} placeholder="" style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
      ...
      <Card>
        ...
        <Fld label="Emotional stress or mental blocks?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.mental_blocks||""} onChange={e=>set("mental_blocks",e.target.value)} placeholder="" style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
      </Card>
      <Card>
      ...
      <DayFolder title="Wins & Challenges" meta="Optional">
        <Fld label="What went well this week?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.what_went_well||""} onChange={e=>set("what_went_well",e.target.value)} placeholder="" style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
        <Fld label="Physical or lifestyle wins?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.lifestyle_wins||""} onChange={e=>set("lifestyle_wins",e.target.value)} placeholder="" style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
        <Fld label="Biggest challenge this week?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.biggest_challenge||""} onChange={e=>set("biggest_challenge",e.target.value)} placeholder="" style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
        <Fld label="Anything holding back progress?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.holding_back||""} onChange={e=>set("holding_back",e.target.value)} placeholder="" style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
      </DayFolder>
      <Card>
        <CardTitle>For Your Coach</CardTitle>
        <Fld label="Anything you want adjusted?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.adjustments||""} onChange={e=>set("adjustments",e.target.value)} placeholder="" style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
        <Fld label="Questions for your coach?"><textarea autoComplete="off" autoCorrect="off" spellCheck={false} rows={2} value={form.coach_questions||""} onChange={e=>set("coach_questions",e.target.value)} placeholder="" style={{width:"100%",background:S.surface2,border:"1px solid "+S.border,color:S.text,padding:"12px 14px",fontSize:14,outline:"none",resize:"vertical"}}/></Fld>
