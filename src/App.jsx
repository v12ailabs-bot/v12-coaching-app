...
const css = `
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .spinner{width:32px;height:32px;border:3px solid ${S.border};border-top-color:${S.accent};border-radius:50%;animation:spin .7s linear infinite;margin:80px auto}
    ...
    <div>
      ...
      {!doneToday && (
        <div style={{background:"rgba(255,77,0,.09)",border:"1px solid rgba(255,77,0,.25)",padding:"13px 18px",display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:20}}>
          <span style={{fontSize:13}}>🔔 <strong style={{color:S.accent}}>Reminder:</strong> Daily check-in not done yet.</span>
