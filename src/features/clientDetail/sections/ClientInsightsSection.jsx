...
// Only ever rendered for coaching clients (ClientDetailPage omits this
// section entirely for program-only clients, who the coach has no
// metrics/tracking visibility into).
