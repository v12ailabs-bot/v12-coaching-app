...
export function ClientHome({ profile, setPage }) {
  ...
  return (
    <div>
      ...
      {!doneToday && (
        <div style={{ background: "rgba(255,106,0,.09)", border: "1px solid rgba(255,106,0,.25)", padding: "13px 18px", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 12, flexWrap: "wrap" }}>
      ...
      <div style={{ marginBottom: 20 }}><ClientHero profile={profile} risk={risk} goalScore={goalScore} setPage={setPage} /></div>

      {risk.flags.length > 0 && (
        <div style={{ background: S.surface, border: "1px solid " + S.border, borderLeft: "3px solid " + (risk.severity >= 2 ? S.danger : S.warning), marginBottom: 20, overflow: "hidden" }}>
      ...
      <div style={{ marginBottom: 20 }}><ProgramRoadmapCard profile={profile} setPage={setPage} /></div>
